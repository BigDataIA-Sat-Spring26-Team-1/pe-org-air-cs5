...
class PatentCollector:
    ...
    async def collect(self, company_name: str, years: int = 5, ticker: str = None) -> CollectorResult:
        """
        Orchestrator entry point.
        """
        logger.info(f"Scanning innovation portfolio for {company_name} (Ticker: {ticker}) using PatentsView")
